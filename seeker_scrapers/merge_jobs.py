...
FRONTEND_JOBS_PATH = os.path.join(BASE_DIR, "all_jobs.json")
...
JOB_FILES = [
    ...
    os.path.join(BASE_DIR, "vodafonepng", "vodafone_jobs.json"),
]

# Mapping from JSON filenames to friendly site names
SOURCE_NAME_MAP = {
    "jobseek_jobs.json": "PNG JobSeek",
    "workboard_jobs.json": "PNG WorkBoard",
    "workforce_jobs.json": "PNG WorkForce",
    "vodafone_jobs.json": "Vodafone PNG",
}
